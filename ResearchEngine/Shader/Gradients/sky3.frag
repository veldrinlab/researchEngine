...
void main ()
{
	vec4 skyHorizon = vec4(255.0/255.0f, 185.0f/255.0f, 108.0f/255.0f, 1.0f);
	vec4 skyZenith = vec4(190.0f/255.0f,6.0f/255.0f,0.0f/255.0f,1.0f);
	
	vec4 checkPoint1 = vec4(255.0f/255.0f,109.0f/255.0f,10.0f/255.0f,1.0f);
	vec4 checkPoint2 = vec4(190.0f/255.0f,6.0f/255.0f,0.0f/255.0f,1.0f);

	float checkPoint1Offset = 0.36f;
